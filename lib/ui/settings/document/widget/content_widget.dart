...
import 'package:requester/ui/settings/document/provider/provider.dart'
    as provider;
import 'package:requester/ui/settings/document/widget/actions/actions.dart';
          ...
          Consumer(builder: (context, ref, _) {
            ...
            return DiffSliverAnimatedList(
              ...
              itemBuilder: (context, source) => ListTile(
                ...
                onTap: () {
                  showDocumentContextActions(ref, source);
                },
                trailing: ActionSyncDocumentSourceWidget(source: source),
              ),
            );
          }),
        ],
...
class _AddAction extends ConsumerWidget {
  /// 添加操作
  const _AddAction();
